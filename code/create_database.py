...
def create_datatables():
    ...
    for filename in os.listdir("data"):
        ...
        cur.execute("CREATE TABLE " + table_name + "(Name, score, language, categorie, size, size_group)")
        with open("data\\" + filename, 'r') as file :
           ...
           for point in data:
               ...
               params = (name, point[-1], row[0][-3], row[0][-2], row[0][-4], row[0][-1])
...
def create_meta_table():
    ...
    cur.execute("CREATE TABLE Metadata(Name, size, language, categorie, size_group)")
    with open("C:\\Users\\Franz\\PycharmProjects\\pythonProject3\\archiv\\datasets_names", "r") as f:
        categorie_data = {}
    ...
    with open("dataset_calls.csv", "r") as f:
        ...
        for line in reader:
            ...
            size_group = get_size_group(int(line[6]))
            params = (name, line[6],line[-1].lower().strip(), delimiter.join(categories), size_group)
